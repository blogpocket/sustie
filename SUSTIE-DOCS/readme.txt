...
Demo link: https://antoniocambronero.com/

## Purpose of the Blogpocket Sustie (english)
...
1. Upload the Blogpocket Sustie theme folder via FTP to your wp-content/themes/ directory.
2. Go to your WordPress dashboard and select Appearance.
3. Activate the Blogpocket Sustie theme.
4. Inside your WordPress dashboard, go to Genesis > Theme Settings and configure them to your liking.

## Theme Support

Please visit https://lanzatu.blog/sustie/ for theme support.

== Frequently Asked Questions ==

= Does this theme support any plugins? =

Blogpocket Sustie includes support for Infinite Scroll in Jetpack and development of pages with Gutenberg.

== Changelog ==

= 1.2.0 - Jan 15 2019 * You can add a widget in the header of the blog page (Welcome) and in the header of the individual posts (Welcome-single).
...
* The Blogpocket Sustie theme has been developed by Antonio Cambronero (https://blogpocket.com)
